class BubbleChart
  ...
  get_color_map_lookup_set: (allValuesArray) =>
    baseArray = ["#1f77b4","#ff7f0e","#2ca02c","#d62728","#9467bd","#8c564b","#e377c2","#7f7f7f","#bcbd22","#17becf"]
    index = 0
    color_map = {}
    for value in allValuesArray
  ...
  show_details: (data, i, element) =>
    # d3.select(element).attr("stroke", "black") // uncomment for border line
    content = ""
  ...
  hide_details: (data, i, element) =>
    # d3.select(element).attr("stroke", "#404040") // uncomment for border line
    @tooltip.hideTooltip()
...
$ ->
  ...
  d3.csv "csv/alunosCurso.csv", render_vis
